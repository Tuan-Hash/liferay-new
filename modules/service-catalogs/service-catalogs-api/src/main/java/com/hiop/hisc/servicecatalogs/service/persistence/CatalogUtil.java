...
package com.hiop.hisc.servicecatalogs.service.persistence;
...
/**
 * The persistence utility for the catalog service. This utility wraps <code>com.hiop.hisc.servicecatalogs.service.persistence.impl.CatalogPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CatalogUtil {
	...
	public static Catalog findByUuid_First(
		...
		throws com.hiop.hisc.servicecatalogs.exception.NoSuchCatalogException {
	 ...
	 * @return the range of matching catalogs
	 */
	public static List<Catalog> findByName(String name, int start, int end) {
	 ...
	 * @return the ordered range of matching catalogs
	 */
	public static List<Catalog> findByName(
	 ...
	 * @throws NoSuchCatalogException if a matching catalog could not be found
	 */
	public static Catalog findByName_First(
	 ...
	 * @return the first matching catalog, or <code>null</code> if a matching catalog could not be found
	 */
	public static Catalog fetchByName_First(
		String name, OrderByComparator<Catalog> orderByComparator) {
	 ...
	 * @throws NoSuchCatalogException if a matching catalog could not be found
	 */
	public static Catalog findByName_Last(
			String name, OrderByComparator<Catalog> orderByComparator)
		throws com.hiop.hisc.servicecatalogs.exception.NoSuchCatalogException {
	 ...
	 * @return the last matching catalog, or <code>null</code> if a matching catalog could not be found
	 */
	public static Catalog fetchByName_Last(
		String name, OrderByComparator<Catalog> orderByComparator) {
	 ...
	 * @throws NoSuchCatalogException if a catalog with the primary key could not be found
	 */
	public static Catalog[] findByName_PrevAndNext(
			long catalogId, String name,
			OrderByComparator<Catalog> orderByComparator)
		throws com.hiop.hisc.servicecatalogs.exception.NoSuchCatalogException {

		return getPersistence().findByName_PrevAndNext(
			catalogId, name, orderByComparator);
	}
	...
	private static volatile CatalogPersistence _persistence;
