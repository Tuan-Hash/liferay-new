 ...
 * <code>com.hiop.hisc.servicecatalogs.service.impl.CatalogLocalServiceImpl</code> and
...
public class CatalogLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.hiop.hisc.servicecatalogs.service.impl.CatalogLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Catalog addEntry(Catalog catalog) throws PortalException {
		return getService().addEntry(catalog);
	}
	...
	public static Catalog deleteEntry(long catalogId) throws PortalException {
		return getService().deleteEntry(catalogId);
	}
