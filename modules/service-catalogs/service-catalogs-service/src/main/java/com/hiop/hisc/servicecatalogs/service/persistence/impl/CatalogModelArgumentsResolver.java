...
/**
 * The arguments resolver class for retrieving value from Catalog.
 *
...
@Component(
	immediate = true,
	service = {CatalogModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class CatalogModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= catalogModelImpl.getColumnBitmask(
					columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(CatalogPersistenceImpl.
	...
	public String getTableName() {
		return CatalogTable.INSTANCE.getTableName();
	}
	...
	static {
		...
		orderByColumnsBitmask |= CatalogModelImpl.getColumnBitmask("name");
