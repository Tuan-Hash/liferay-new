...
> {
  ...
  render() {
    ...
    return (
      <div
        className={cx(
          this.style['toolbar-button'] ,
          icon,
          this.style[status],
          disabled && this.style.disabled,
          ...(this.props.className ? this.props.className.split(' ').map(c => `${this.style['toolbar-button']}-${c}`) : [])
        )}
  ...
  render() {
    ...
    return shown && (
      <div className={this.style.dropdown}>
        <div className={this.style['dropdown-pointer']} style={{ left: pointerPosition }}>&nbsp;</div>
        <div className={this.style['dropdown-body']}>
          { children }
        </div>
      </div>
    );
