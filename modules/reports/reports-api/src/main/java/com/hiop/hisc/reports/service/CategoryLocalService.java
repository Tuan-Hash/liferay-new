...
public interface CategoryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.hiop.hisc.reports.service.impl.CategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
