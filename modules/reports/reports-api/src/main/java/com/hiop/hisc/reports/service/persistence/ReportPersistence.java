...
public interface ReportPersistence extends BasePersistence<Report> {
	 ...
	 */
	public java.util.List<Report> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Report> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Report> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Report>
			orderByComparator);
	 ...
	 * @return the matching reports
	 */
	public java.util.List<Report> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching reports
	 */
	public java.util.List<Report> findByUuid_C(
	 ...
	 * @return the matching reports
	 */
	public java.util.List<Report> findByName(String name);
	 ...
	 * @return the range of matching reports
	 */
	public java.util.List<Report> findByName(String name, int start, int end);
	 ...
	 * @return the ordered range of matching reports
	 */
	public java.util.List<Report> findByName(
