...
/**
 * Provides the local service interface for Report. Methods of this
...
public interface ReportLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.hiop.hisc.reports.service.impl.ReportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the report local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReportLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Report createReport(ReportPK reportPK);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Report deleteReport(ReportPK reportPK) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Report fetchReport(ReportPK reportPK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Report getReport(ReportPK reportPK) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Report> getReportsByUuidAndCompanyId(
