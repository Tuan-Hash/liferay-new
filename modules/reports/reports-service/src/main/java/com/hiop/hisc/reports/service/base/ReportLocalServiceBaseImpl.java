...
package com.hiop.hisc.reports.service.base;

import com.hiop.hisc.reports.model.Report;
import com.hiop.hisc.reports.service.ReportLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hiop.hisc.reports.service.impl.ReportLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.hiop.hisc.reports.service.impl.ReportLocalServiceImpl
 * @generated
 */
public abstract class ReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ReportLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReportLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReportLocalServiceUtil</code>.
	 */
	...
	public Report createReport(ReportPK reportPK) {
		return reportPersistence.create(reportPK);
	}
	...
	public Report deleteReport(ReportPK reportPK) throws PortalException {
		return reportPersistence.remove(reportPK);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return reportPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Report.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return reportPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return reportPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Report fetchReport(ReportPK reportPK) {
		return reportPersistence.fetchByPrimaryKey(reportPK);
	}
	...
	public Report getReport(ReportPK reportPK) throws PortalException {
		return reportPersistence.findByPrimaryKey(reportPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(reportLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Report.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("primaryKey.reportId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(reportLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Report.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Report>() {

				@Override
				public void performAction(Report report)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, report);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return reportPersistence.create((ReportPK)primaryKeyObj);
	}
	...
	@Override
	public BasePersistence<Report> getBasePersistence() {
	...
	public List<Report> getReportsByUuidAndCompanyId(
		...
		return reportPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Report> getReportsByUuidAndCompanyId(
		...
		return reportPersistence.findByUuid_C(
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReportLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		reportLocalService = (ReportLocalService)aopProxy;

		_setLocalServiceUtilService(reportLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ReportLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, reportLocalService);
		}
