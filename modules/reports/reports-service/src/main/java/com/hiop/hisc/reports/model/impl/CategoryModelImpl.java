...
import com.hiop.hisc.reports.model.CategoryModel;
...
/**
 * The base model implementation for the Category service. Represents a row in the &quot;hisc_report_Category&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CategoryModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "hisc_report_Category";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"description", Types.VARCHAR}, {"icon", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table hisc_report_Category (uuid_ VARCHAR(75) null,categoryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(500) null,icon VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table hisc_report_Category";

	public static final String ORDER_BY_JPQL = " ORDER BY category.name ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY hisc_report_Category.name ASC";
	...
	static {
		...
		attributeGetterFunctions.put("icon", Category::getIcon);
		attributeSetterBiConsumers.put(
			"icon", (BiConsumer<Category, String>)Category::setIcon);
	...
	public Category cloneWithOriginalValues() {
		...
		categoryImpl.setIcon(this.<String>getColumnOriginalValue("icon"));
	...
	public CacheModel<Category> toCacheModel() {
		...
		categoryCacheModel.icon = getIcon();

		String icon = categoryCacheModel.icon;

		if ((icon != null) && (icon.length() == 0)) {
			categoryCacheModel.icon = null;
		}
